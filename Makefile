...
sourceFromFreeciv: compileCodeGenerator
	${SCALA} -classpath ${PACKETGENOUT}:${PROTOOUT} org.freeciv.packetgen.GeneratePackets ${FREECIV_SOURCE_PATH}
	touch sourceFromFreeciv

compileFromFreeciv: sourceFromFreeciv
	${JAVAC} -d ${PROTOOUT} -cp ${PROTOOUT} ${GENERATED_SOURCE_FOLDER}/org/freeciv/*/*.java ${GENERATED_SOURCE_FOLDER}/org/freeciv/*/*/*.java
	cp ${GENERATED_SOURCE_FOLDER}/org/freeciv/packet/packets.txt ${PROTOOUT}/org/freeciv/packet/
...
compileTestPeers: compileCodeGenerator compileBasicProtocol sourceTestPeers
	${JAVAC} -d ${PROTOOUT} -cp ${PROTOOUT} ${GENERATED_SOURCE_FOLDER}/org/freeciv/*/*.java \
