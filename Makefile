...
sourceTestPeers: compileBasicProtocol compileCodeGenerator
	...
	${JAVA} -cp ${COMPILED_TESTS_FOLDER}:${COMPILED_GENERATOR_FOLDER}:${COMPILED_PROTOCOL_FOLDER} org.freeciv.packetgen.GenerateTest
	touch sourceTestPeers

compileTestPeers: compileCodeGenerator compileBasicProtocol sourceTestPeers
	${JAVAC} -d ${COMPILED_PROTOCOL_FOLDER} -cp ${COMPILED_PROTOCOL_FOLDER} ${GENERATED_SOURCE_FOLDER}/org/freeciv/*/*.java \
	                                        ${GENERATED_SOURCE_FOLDER}/org/freeciv/*/*/*.java
	cp ${GENERATED_SOURCE_FOLDER}/org/freeciv/packet/packets.txt ${COMPILED_PROTOCOL_FOLDER}/org/freeciv/packet/
...
compileTestGeneratedCode: compileTestPeers folderTestOut
	${JAVAC} -d ${COMPILED_TESTS_FOLDER} -cp ${COMPILED_GENERATOR_FOLDER}:${COMPILED_PROTOCOL_FOLDER}:${JUNIT} Tests/org/freeciv/test/*.java
...
clean:
	...
	rm -rf ${GENERATED_SOURCE_FOLDER}/* sourceTestPeers
...
distclean: clean
	rm -rf out ${GENERATED_SOURCE_FOLDER}
